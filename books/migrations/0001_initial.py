    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('images_path', models.ImageField(blank=True, upload_to='books/images')),
                ('file_path', models.FileField(blank=True, upload_to='books/e_books')),
                ('review', models.CharField(db_column='Рецензия', max_length=2000, verbose_name='Рецензия')),
            ],
            options={
                'verbose_name': 'книга',
